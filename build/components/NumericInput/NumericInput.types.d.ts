...
export declare enum IncrementDirection {
    DOWN = -1,
    UP = 1
}
export declare const NON_HTML_PROPS: Array<keyof NumericInputProps>;
export declare type ButtonEventHandlers = Required<Pick<React.HTMLAttributes<Element>, "onKeyDown" | "onMouseDown">>;
