...
import { PopoverSharedProps, PopoverInteractionType } from "../Popover/Popover.types";
import { IIntentProps } from "../../common";
export interface TooltipProps extends PopoverSharedProps, IIntentProps {
    content: JSX.Element | string;
    interactionKind?: typeof PopoverInteractionType.HOVER | typeof PopoverInteractionType.TARGET_HOVER;
    /**
     ...
     * @default 100
     */
    placement: "top" | "bottom" | 'top-start' | 'top-end' | 'right' | 'right-start' | 'right-end' | 'bottom' | 'bottom-start' | 'bottom-end' | 'left' | 'left-start' | 'left-end';
}
