...
import {PopoverInteractionType as PopoverInteractionKind , PopoverProps as  IPopoverProps}  from "../Popover/Popover.types"
    ...
    private maybeRenderPopover(target: JSX.Element, children?: React.ReactNode) {
        ...
        return (
            <Popover
                ...
                enforceFocus={false}
                hoverCloseDelay={0}
                interactionType={PopoverInteractionKind.HOVER}
